...
def create_vm():
    ...
    if os.isfile(mount_drive() + name + ".qcow2"):
    ...
    os.system("virt-install --name={} --ram={} --vcpus={} --disk path={},size=100 --os-type={} --os-variant={} --network bridge=br0 --graphics vnc,listen=5900 --console pty,target_type=serial --location '{}' --extra-args 'console=ttyS0,115200n8 serial' --noreboot".format(name, ram, cpu, vm_image_location, os_type, os_variant, location))
